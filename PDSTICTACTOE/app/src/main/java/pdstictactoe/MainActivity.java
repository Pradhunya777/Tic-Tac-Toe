package com.example.lenovo.pdstictactoe;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void player1wins() {
        player1Points++;
        Toast.makeText( this,  "Congo Player 1 wins!", Toast.LENGTH_SHORT).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2wins() {
        player2Points++;
        Toast.makeText( this,  "Congo Player 2 wins!", Toast.LENGTH_SHORT).show();
        updatePointsText();
        resetBoard();
    }
